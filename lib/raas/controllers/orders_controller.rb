  ...
  class OrdersController < BaseController
    ...
    def get_order(reference_order_id)
      begin
        ...
        _path_url = '/orders/{referenceOrderID}'
    ...
    # reference order id
    # @param [OrderResendCriteriaModel] order_resend_criteria Optional
    # parameter: Example:
    # @return ResendOrderResponseModel response from the API call
    def create_resend_order(options = {})
      begin
        @logger.info("create_resend_order called.")
        # Validate required parameters.
        @logger.info("Validating required parameters for create_resend_order.")
        validate_parameters(
          'reference_order_id' => options['reference_order_id']
        )
        # Prepare query url.
        @logger.info("Preparing query URL for create_resend_order.")
        _path_url = '/orders/{referenceOrderID}/resends'
        _path_url = APIHelper.append_url_with_template_parameters(
          _path_url,
          'referenceOrderID' => options['reference_order_id']
        )
        _query_builder = Configuration.get_base_uri
        _query_builder << _path_url
        _query_url = APIHelper.clean_url _query_builder
        ...
        _request = @http_client.post(
          _query_url,
          headers: _headers,
          parameters: options['order_resend_criteria'].to_json
        )
        BasicAuth.apply(_request)
